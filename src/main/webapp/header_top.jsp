<div class="bg-blue" align="center">
        <form action="headerMenu" method="GET">
            ...
            <input type="submit" name="editAddressesButton" class="btn btn-default btn-margin" value="${menuButtonEditAddresses}" />
            <input type="submit" name="editTemplatesButton" class="btn btn-default btn-margin" value="${menuButtonEditTemplates}" />
        </form>
</div>
